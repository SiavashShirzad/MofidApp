...
namespace MOFIDAPP
{
    ...
    public class refrences : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ref4.TextFormatted = Android.Text.Html.FromHtml("Only CDC refrences was used for 10 - 20 years old Weight for age  : " + "https://www.cdc.gov/growthcharts/zscore.htm");
